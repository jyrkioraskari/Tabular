...
Students do not need Node.js, npm, or a command prompt. Download one of the Windows releases available at: https://github.com/jyrkioraskari/TabularRDM/releases :
